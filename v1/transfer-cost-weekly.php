  ...
  <body class="text-center">
    ...
    <div class="d-flex w-100 h-100 p-3 mx-auto flex-column">
      <header class="masthead mb-auto">
        <div class="inner">
          <h3 class="masthead-brand"><a href="/v1/">CC 2019/2020</a></h3>
          <nav class="nav nav-masthead justify-content-center">
            <a class="nav-link" href="/v1/point-weekly.php">Point</a>
            <a class="nav-link active" href="/v1/transfer-cost-weekly.php">Cost</a>
    ...
    <script src="/assets/js/transfer-cost-weekly.js"></script>
